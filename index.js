...
function superhero(hero, power, city){
    return hero + " uses " + power+ " to protect " + city + "."
}

// Step 4: Call the function below for Spider-Man, Magneto, & Wonder Woman
console.log(superhero("Spiderman", "Web-slinging", "New York City"))
console.log(superhero("Magneto", "magnetic field manipulation", "Genosha"))
console.log(superhero("Wonder Woman", "super strength", "Themyscira"))
...
console.log(superhero("Iron Man", "Iron Man Suit", "New York City"))
console.log(superhero("Batman", "Rich", "Gotham"))
